...
export function GET(): Response {
  const body = buildLlmsTxt({
    ...
    summary:
      'Taikiken (太氣拳) é uma arte marcial interna japonesa fundada em 1947 pelo Mestre Kenichi Sawai (1902–1988), após receber a bênção de seu mestre, o Grão-Mestre Wang Xiangzhai (1885–1963), criador do Yiquan (I Chuan, "Boxe da Mente") em 1932. Em Portugal, o Taikiken é ensinado por Joe Rosario-Sensei, instrutor com mais de 20 anos de prática e aluno direto de Masamichi Fukushima-Sensei. As aulas acontecem em Vila Nova de Gaia (área metropolitana do Porto), próximo ao Metro Dom João II.',
    sections: [
      {
        ...
        links: [
          ...
          { url: '/mestres', label: 'Mestres (Sawai, Takagi, Fukushima, Joe Rosario)' },
      ...
      },
      {
        title: 'Linhagem',
        links: [
          { url: '/mestres', label: 'Wang Xiangzhai → Sawai Sensei → Takagi/Fukushima → Joe Rosario-Sensei' },
        ],
      },
    ],
  })
