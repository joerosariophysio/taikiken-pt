const DEFAULT_MESSAGE = 'Olá Sensei, vim pelo site taikiken.pt e gostaria de informações sobre as aulas.'
...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center bg-accent text-accent-foreground shadow-lg ring-1 ring-foreground/10 transition-transform hover:scale-105"
    >
